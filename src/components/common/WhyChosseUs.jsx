export default function WhyChooseUs() {
  return (
    <section className="w-full h-screen max-h-screen overflow-hidden p-6 flex flex-col gap-6">
      <h3 className="text-3xl text-olive-dark font-semibold text-left md:text-center">
        Why Choose Us
      </h3>
      ...
      <div className="flex gap-4 overflow-x-auto scroll-smooth snap-x snap-mandatory h-full pb-4">
        {/* Card 1 */}
        <div className="snap-start flex-shrink-0 w-72 bg-gray-200 p-5 rounded-md text-olive flex flex-col gap-4">
        ...
        {/* Card 2 */}
        <div className="snap-start flex-shrink-0 w-72 bg-gray-200 rounded-md text-olive flex flex-col gap-4">
